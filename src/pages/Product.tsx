...
function Product() {
  ...
  return (
    <div className="p-8">
      ...
      <FabricCard imageUrl={fabric.f1} description={fabricDescription} />
      <FabricCard imageUrl={fabric.f2} description={fabricDescription} />

      <div className="mb-5 flex justify-center gap-10 flex-wrap">
        <ClothCard imageUrl={clothes.c1} title="Cloth1" />
        <ClothCard imageUrl={clothes.c1} title="Cloth1" />
        <ClothCard imageUrl={clothes.c1} title="Cloth1" />
        <ClothCard imageUrl={clothes.c1} title="Cloth1" />
      </div>
